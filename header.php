...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light menucolor">
    ...
    <div class="collapse navbar-collapse menucolor col-sm-9" id="navbarSupportedContent">
      <ul class="text-uppercase w-100 navbar-nav mx-auto">
        ...
        <li class="nav-item dropdown espaco">
          <a class="nav-link dropdown-toggle text-light" href="" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Produtos</a>
          <div class="dropdown-menu onlyblack" aria-labelledby="navbarDropdown">
        ...
        <li class="nav-item dropdown espaco">
          <a class="nav-link dropdown-toggle text-light" href="" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Vendas</a>
          <div class="dropdown-menu onlyblack" aria-labelledby="navbarDropdown">
  ...
  <div class="menu">
    ...
    <label><?php if (isset($_SESSION['login'])) {
              echo " Bem-vindo: ";
              echo $_SESSION['login'];
